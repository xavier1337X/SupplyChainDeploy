          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            >
              <div className=" text-3xl md:pr-4 lg:pr-12 xl:pr-16 mb-8">
                ...
                <p className="text-xl text-gray-600">
                  Maximize the efficiency, transparency, and collaboration of your supply chain network, while reducing
                  costs and enhancing customer satisfaction, with our advanced platform.
                </p>
              </div>
              {/* Tabs buttons */}
